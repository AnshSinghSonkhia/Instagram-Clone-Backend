...
// jo user input kr rha hai, index.ejs mai - usko apan require kr rhe hai
router.post("/register", function (req, res, next) {
  ...
  // user ka password le kr verify krenge phir usko authenticate krenge
...
// Never Never Never use this function in routes -
// "/", "/register" and "/login"
// Otherwise, user will be loggedin without authentication.
